...
public class getBrowserName {
	...
	dr.findElement(By.linkText("Duplicate Lead")).click();
		...
		//To click the Create contact
		dr.findElement(By.linkText("Create Contact")).click();
		
		//To enter the firstname and last name field	
		dr.findElement(By.id("firstNameField")).sendKeys("saravana");
		dr.findElement(By.id("lastNameField")).sendKeys("kumar");
		
		//To click create contact
		dr.findElement(By.name("submitButton")).click();
		
		//To print Firstname and Browser title
		WebElement printFirstNameField=dr.findElement(By.id("viewContact_firstName_sp"));
		String firstname=printFirstNameField.getText();
	    System.out.println("The First Name is=="+firstname);
	    
	    //System.out.println(dr.findElement(By.id(viewContact_firstName_sp).getText()));
	    
	    
	    //To println the Title of the page
